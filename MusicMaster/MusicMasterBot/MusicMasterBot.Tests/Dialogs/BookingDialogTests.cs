...
using MusicMasterBot.Tests.Dialogs.TestData;
...
namespace MusicMasterBot.Tests.Dialogs
{
    public class BookingDialogTests : BotTestBase
    {
        ...
        public async Task DialogFlowUseCases(TestDataObject testData)
        {
            ...
            var bookingResults = (SongRequest)testClient.DialogTurnResult.Result;
            Assert.Equal(bookingTestData.ExpectedBookingDetails?.Artist, bookingResults?.Artist);
            Assert.Equal(bookingTestData.ExpectedBookingDetails?.Title, bookingResults?.Title);
            Assert.Equal(bookingTestData.ExpectedBookingDetails?.Album, bookingResults?.Album);
        }
